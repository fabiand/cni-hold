...
c "Create fedora (it's on-hold by default)"
x "kubectl create -f manifests/fedora.yaml"
...
n
c "Unhold it"
x "kubectl patch pod fedora --patch-file manifests/unhold.yaml"
...
n
c "Delete it"
x "kubectl delete -f manifests/fedora.yaml"
